...
| 已标注 | 2,060 |
| 待人工标注 | 4（网络下载实拍图） |
| 处方类型 | 19种（中药/西药/中西结合/手写/住院/急诊/颗粒/特殊/中成药/外用/复杂多药/儿科/横版/电子处方/医保处方/涂改处方/检验处方 + 变体） |
| 覆盖科室 | 65+ |
...
### 难度等级
- **Easy**（359张）：白色背景，标准字体，清晰排版
- **Medium**（653张）：轻微噪点，模拟打印质量波动
- **Hard**（1,052张）：明显噪点，模拟实拍条件（纸张泛黄、字迹模糊、手写风格、旋转、印章、低分辨率、运动模糊、涂改痕迹）

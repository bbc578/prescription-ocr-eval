...
| 已标注 | 1,000 |
| 待人工标注 | 4（网络下载实拍图） |
| 处方类型 | 15（中药/西药/中西结合/手写/住院/急诊/颗粒/特殊/中成药/外用/复杂多药/儿科/横版/中药扩展/西药扩展） |
| 覆盖科室 | 61 |
| 难度分布 | Easy: 239 / Medium: 375 / Hard: 390 |
...
### 难度等级
- **Easy**（239张）：白色背景，标准字体，清晰排版
- **Medium**（375张）：轻微噪点，模拟打印质量波动
- **Hard**（390张）：明显噪点，模拟实拍条件（纸张泛黄、字迹模糊、手写风格、轻微旋转、印章效果）
